...
const WeatherWidget = () => {
  ...
  **Note that the values passed into the URL are dynamic and depends on the user input.
  ...
  const BASE_URL = `https://api.openweathermap.org/data/2.5/weather?q=${input.city},${input.code}&APPID=d0b4b802f1005ab8e1b81831dddae216`;
  ...
  return (
    <div>
      <h1 className="weer-heading">Weer Voorspelling</h1>
